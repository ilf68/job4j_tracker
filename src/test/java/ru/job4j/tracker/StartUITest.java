...
class StartUITest {
    ...
    void whenFindByIdAction() {
        ...
        Item two = tracker.add(new Item("test1"));
        Input input = new MockInput(
                new String[] {"0", String.valueOf(one.getId()), "0", String.valueOf(two.getId()), "1"}
        );
        UserAction[] actions = new UserAction[]{
    ...
    void whenFindByNameAction() {
        ...
        Item two = tracker.add(new Item("test1"));
        Input input = new MockInput(
                new String[] {"0", String.valueOf(one.getName()), "0", String.valueOf(two.getName()), "1"}
        );
        UserAction[] actions = new UserAction[]{
